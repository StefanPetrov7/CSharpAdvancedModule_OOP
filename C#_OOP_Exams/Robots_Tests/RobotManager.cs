    ...
    public class RobotManager
    {
        ...
        public int Capacity
        {
            ...
            private set
            {
                if (value < 0)
                {
                    throw new ArgumentException("Ivalid capacity!");
                }
                this.capacity = value;
            }
        }
        ...
        {
            if (this.robots.Any(x => x.Name == robot.Name))
            {
        ...
        {
            Robot robotToRemove = this.robots.FirstOrDefault(x => x.Name == name);
        ...
        {
            Robot robot = this.robots.FirstOrDefault(x => x.Name == robotName);
            ...
            {
                throw new InvalidOperationException($"{robotName} doesn't have enough battery!");
            }
